window.addEventListener("DOMContentLoaded", event => {
  document.getElementById("login").addEventListener("submit", function(e) {
    ...
    let name_hash = sha1(name);
    let pass_hash = sha1(pass);
    console.log(name, pass, name_hash, pass_hash);
    if (
      name_hash == "c98c8fc68d3939fbb1b2d50f52fbe006ffae2cb3" &&
      pass_hash == "e68e11be8b70e435c65aef8ba9798ff7775c361e"
    ) {
      // valid
      loginCorrect();
      return true;
...
function loginCorrect() {
  ...
  window.location.href = "sat/"; //relative to domain
}
